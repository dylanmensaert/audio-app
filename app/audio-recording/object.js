...
export default Ember.Object.extend({
    ...
    isQueued: function() {
        return this.get('fileSystem.albums').findBy('name', 'Queue').get('recordings').contains(this.get('id'));
    }.property('fileSystem.albums.@each.recordings.[]', 'id'),
    isDownloadLater: function() {
        return this.get('fileSystem.albums').findBy('name', 'Download later').get('recordings').contains(this.get('id'));
    }.property('fileSystem.albums.@each.recordings.[]', 'id'),
    ...
    insert: function() {
        ...
        return new Ember.RSVP.Promise(function(resolve, reject) {
            Ember.RSVP.hash(promises).then(function(hash) {
                ...
                this.get('fileSystem.albums').findBy('name', 'Download later').get('recordings').removeObject(this.get('id'));
    ...
    strip: function() {
        return this.getProperties('id', 'name', 'extension', 'thumbnail');
    }
});
